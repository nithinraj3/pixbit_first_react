...
import { userRegistered } from "../redux/authentication/registerDetails";
...
const Register = (props) => {
  ...
  const userRegisterDispatch = useDispatch();
  ...
  const placeSubmitHandler = async (event) => {
    ...
    try {
      const responseData = await axios.post(
        "http://training.pixbit.in/api/register",
        registerDetails,
        {
          headers: {
      ...
      localStorage.setItem(
        "userData",
        JSON.stringify(responseData.data.data.access_token)
      );

      userRegisterDispatch(
        userRegistered({
          tokenState: true,
          tokenValue: responseData.data.data.access_token,
        })
      );
      setLoading(false);
      ...
      console.log("Register post " + err.message);
    }
  };
